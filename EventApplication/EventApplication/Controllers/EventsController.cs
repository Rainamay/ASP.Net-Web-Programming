...
namespace EventApplication.Controllers
{
    public class EventsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventId,EventTypeId,EventTitle,EventDescription,StartDate,EndDate,City,State,OrganizerName,OrganizerContact,MaxTickets,AvailableTickets")] Event @event)
        {
            if (ModelState.IsValid)
            {
